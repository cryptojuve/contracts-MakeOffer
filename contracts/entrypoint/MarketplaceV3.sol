...
import {ERC721Holder} from
    "lib/creator-token-standards/lib/openzeppelin-contracts/contracts/token/ERC721/utils/ERC721Holder.sol";
import {
    ERC1155Holder,
    ERC1155Receiver
} from "lib/creator-token-standards/lib/openzeppelin-contracts/contracts/token/ERC1155/utils/ERC1155Holder.sol";
...
import "lib/contracts/contracts/extension/upgradeable/PlatformFee.sol";
    ...
    ERC165
{
        ...
        returns (bool)
    {
        return interfaceId == type(IERC1155Receiver).interfaceId || interfaceId == type(IERC721Receiver).interfaceId
            || interfaceId == type(IRouter).interfaceId || interfaceId == type(IRouterState).interfaceId
